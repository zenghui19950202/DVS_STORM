#!/usr/bin/env python
# -*- coding: UTF-8 -*-
# Author  ：zh , Date  ：2021/3/17 10:29
...
class Unet_4x_ANN(nn.Module):
    def __init__(self):
        super(Unet_4x_ANN, self).__init__()
        self.up_4x = nn.Upsample(scale_factor=4, mode='bilinear', align_corners=True)
        self.in_conv = nn.Conv2d(1, 16, 3, 1, 1)
        ...
        self.out_conv = nn.Conv2d(16, 1, 1, 1)
        self.relu = nn.ReLU()
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.conv3x3 = nn.Conv2d(1, self.inplanes, kernel_size=3, stride=1, padding=1,
                                 bias=False)
        ...
        self.spike_activation = spike_activation()
...
class spike_activation(nn.Module):
    def __init__(self):
        super(spike_activation, self).__init__()
...
if __name__ == '__main__':
    net = Unet_4x_ANN()
    summary(net, input_size=[(1, 128, 128)], batch_size=1, device="cpu")
